    ...
    return (
        <div className="flex items-center justify-center min-h-screen max-w-lg mx-auto">
            <div
                ...
                <div>Don't have an account? <Link className="link link-hover text-error font-bold tracking-wide" to="/register">Register</Link>
                </div>
                <button
                    onClick={submitForm}
                    disabled={isLoading}
                ...
                <div className="flex w-full justify-between items-center max-w-md pt-2">
                    <button onClick={handleLoginAsUser} className="btn btn-default btn-sm">Login as User</button>
                    <button onClick={handleLoginAsAdmin} className="btn btn-default btn-sm">Login as Admin</button>
                </div>
            </div>
        </div>
    )
