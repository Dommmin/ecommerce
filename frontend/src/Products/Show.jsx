...
function Show() {
    ...
    const { data: variant, isPending, isLoading, refetch, error } = useQuery({
        queryKey: ['product', id],
        queryFn: getProduct,
        ...
        <div>
                ...
                {variant.images.map((image, index, imagesArray) => (
                    <div key={index + 1} id={'slide' + (index + 1)} className="carousel-item relative w-full">
                        ...
                        <div
                            ...
                            <a href={'#slide' + (((index - 1 + imagesArray.length) % imagesArray.length) + 1)}
                               className="btn btn-circle">❮</a>
                            <a href={'#slide' + (((index + 1) % imagesArray.length) + 1)}
                               className="btn btn-circle">❯</a>
                        </div>
                    </div>
                ))}
            ...
            <div className="block lg:hidden">
                ...
                <div className="p-2 space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                        <p className="line-through text-error text-sm">
